...
print(f"current time {main_timer}")
while True:
    ...
    pressure = float(raw_data[3])                     # int as 12 bit signal --> 0 corresponds to 0barg; 4095 correponds to 10barg
    ...
    action=P/10*4095                                               # for PID PID(x,h,kp,ki,kd)*1e5   
